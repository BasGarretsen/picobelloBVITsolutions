...
<form method="POST" action="{{ isset($activity) ? route('activities.update', $activity->id) : route('storeActivity') }}" class="max-w-lg mx-auto bg-[#f5af00] my-10 p-10 rounded-2xl shadow-2xl" enctype="multipart/form-data">
    ...
    <h1 class="text-4xl text-white font-bold mb-4">{{ isset($activity) ? 'Update Activity' : 'Create Activity' }}</h1>

    <div class="grid grid-cols-2 gap-3">
        <div class="mb-5">
            <label for="activity_name" class="block mb-2 text-sm font-medium text-gray-900 text-white">Activity Name</label>
        ...
        <div class="mb-5">
            <label for="minimum_participants" class="block mb-2 text-sm font-medium text-gray-900 text-white">Minimum Participants</label>
        ...
        <div class="mb-5">
            <label for="maximum_participants" class="block mb-2 text-sm font-medium text-gray-900 text-white">Maximum Participants</label>
        ...
        <div class="mb-5">
            <label for="image" class="block mb-2 text-sm font-medium text-gray-900 text-white">Image URL</label>
        ...
        <div class="mb-5">
            ...
            <option value="yes" {{ old('including_food', $activity->including_food) === 'yes' ? 'selected' : '' }}>Yes</option>
