        ...
        <section class="cards block md:grid md:grid-cols-2 lg:grid-cols-3 my-10 gap-10">
            ...
            <div class="card bg-[#f5af00] w-72 rounded-2xl shadow-2xl my-10 md:my-0">
                ...
                <div class="px-4 md:p-4 text-white">
                    ...
                    <p><span class="material-icons">schedule</span>: <span class="text-black">{{$activity['start_time']}}</span></p>
                    <p><span class="material-icons">alarm_off</span>: <span class="text-black">{{$activity['end_time']}}</span></p>
