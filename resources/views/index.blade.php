        ...
        <section class="cards block md:grid md:grid-cols-2 lg:grid-cols-3 my-10 gap-10">
            ...
            <div class="card bg-[#f5af00] w-72 rounded-2xl shadow-2xl my-10 md:my-0">
                ...
                <div class="px-4 md:p-4 text-white">
                    ...
                    <p>Aantal inschrijvingen: <span class="text-black"><!-- Waarde van array.count() meegegeven als parameter, array is alle resultaten van de registraties waar de activityId gelijk is aan de id van de activiteit. --></span></p>
                </div>
